...
const Card = ({ name, capital, region, area, population, continents, flags, maps, theme }) => {
    ...
    return (
        <div className={`w-[310px] pb-3 shadow-xl flex flex-col gap-4 rounded-xl ${theme==='light'? "bg-white text-black" : 'bg-gray-800 text-white'} transition-colors duration-300`}>
